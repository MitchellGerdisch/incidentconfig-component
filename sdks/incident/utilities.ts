...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("incident");
			params.setVersion("5.30.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2luY2lkZW50LWlvL2luY2lkZW50IiwidmVyc2lvbiI6IjUuMzAuMCJ9fQ=="), c => c.charCodeAt(0)));
